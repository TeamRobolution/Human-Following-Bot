...
ser = serial.Serial('COM10', 250000)  # change if serial not COM13
...
face_cascade = cv2.CascadeClassifier('C:/Users/DELL/Documents/all_cpp/basics/Bots/haarcascade_frontalface_alt.xml.xml')
